...
ALLOWED_HOSTS = ['https://ecommerelearning-production.up.railway.app', 'ecommerelearning-production.up.railway.app']
CSRF_TRUSTED_ORIGINS = ['https://ecommerelearning-production.up.railway.app', 'ecommerelearning-production.up.railway.app']
